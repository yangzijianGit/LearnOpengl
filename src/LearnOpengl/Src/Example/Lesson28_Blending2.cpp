...
void Lesson28::prefix()
{
    ...
    transparentTexture = util::loadTexture("res/blending_transparent_window.png");
    shader.use();
...
void Lesson28::show()
{
    ...
    {
        model = glm::translate(glm::mat4(1.0f), *rIt);
        shader.setMat4("model", model);
        glDrawArrays(GL_TRIANGLES, 0, 6);
    }
}
