...
void Lesson22::prefix()
{
	glEnable(GL_DEPTH_TEST);

	lightSourceShader.read("1.light_cube.vs", "1.light_cube.fs");
	lightShader.read("5.3.light_casters.vs", "5.3.light_casters.fs");
...
void Lesson22::show()
{
	...
	lightShader.setFloat("light.linear", 0.027f);
	lightShader.setFloat("light.quadratic", 0.0028f);
